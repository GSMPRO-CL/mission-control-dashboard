  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Customer Services (SLA)</h1>
          <p className="text-zinc-400 mt-1">Análisis de rendimiento, tiempos de respuesta e inteligencia emocional.</p>
        </div>
