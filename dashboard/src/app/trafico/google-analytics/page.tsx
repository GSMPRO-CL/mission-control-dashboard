    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 p-6 rounded-2xl border border-white/10 bg-zinc-950/50 backdrop-blur-xl flex flex-col relative overflow-hidden">
          <h2 className="text-lg font-bold text-white mb-6 relative z-10">Métricas de Conversión</h2>
          ...
          <div className="flex-1 flex flex-col justify-center gap-8 relative z-10">
            <div className="bg-zinc-900/50 border border-white/5 rounded-xl p-5 flex flex-col items-center justify-center relative overflow-hidden">
              <span className="text-zinc-400 text-sm mb-2">Añadidos al Carrito</span>
              <span className="text-3xl font-bold text-amber-400">
                {data ? formatNumber(data.kpis.addToCarts) : '...'}
              </span>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-amber-500/10 rounded-full blur-2xl" />
            </div>

            <div className="bg-zinc-900/50 border border-white/5 rounded-xl p-5 flex flex-col items-center justify-center relative overflow-hidden">
              <span className="text-zinc-400 text-sm mb-2">Conversiones Totales</span>
